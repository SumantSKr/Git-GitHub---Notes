...
Once you downloaded the Git on your computer you are ready to work with Git ( Version Control System ). As a first command you can type $\color{Blue}{\text{*git --version*}}$ to check the version of git on your computer.
